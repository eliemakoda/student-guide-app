...
$sql = "select * , matiere.nom as mnom, examen.nom as enom from examen left join matiere on examen.id_matiere=matiere.id;";
$apps = new App;
$resultat = $apps->SelectionnerTout($sql);
if(isset($_POST["rechercher"]))
{
    $nom=$_POST["nomrech"];
    $sql="SELECT * FROM examen where nom like '%$nom%' ";
    $resultat=$apps->SelectionnerTout($sql);
}
require "./header.php";
?>
...
<div class="page-wrapper">
  <div class="content container-fluid">
    ...
    <form method="POST" action="./ListeExamen.php">

      <div class="student-group-form">
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="form-group">
              <input type="text" class="form-control" placeholder="rechercher par nom ..." name="nomrech" />
            </div>
          </div>
          <div class="col-lg-2">
                      ...
                      <tr>
                        ...
                        <td>
                          <h2 class="table-avatar">
                            <a href="detailMatiere.php"><?php echo $matiere->enom ?></a>
                          </h2>
                        </td>
                        <td><?php echo $matiere->mnom ?></td>
